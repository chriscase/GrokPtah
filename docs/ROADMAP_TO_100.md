...
- Keep the current TypeScript/desktop verification attached to the same reviewable
  ...
  hardening/corpus/public-consumer commits through `2f026ff2` pass 47 test files /
  263 tests, typecheck, the production Vite build, and `npm run verify:public`.
