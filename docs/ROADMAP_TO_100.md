...
| 4. Gateway and enterprise | Least-privilege gateway profiles, quota/route truth, review through restricted company gateways, and external worker routes | [Provider profiles](./PROVIDER_PROFILES.md); Cursor Cloud adapter design is documented, while live enterprise/Cursor certification remains unverified | In progress |
