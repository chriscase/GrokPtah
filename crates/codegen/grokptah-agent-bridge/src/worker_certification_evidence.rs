...
pub const WORKER_CERTIFICATION_EVIDENCE_SCHEMA: &str = "grokptah.worker-certification-evidence.v1";
    ...
    fn evidence(claim_eligible: bool) -> LongRunningWorkerEvidence {
        LongRunningWorkerEvidence {
            ...
            credential_lifecycle: ["worker-a", "worker-b"]
                .into_iter()
                .map(|bound_agent_id| WorkerCredentialLifecycleEvidence {
