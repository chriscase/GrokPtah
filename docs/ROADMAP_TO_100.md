...
- Keep the current TypeScript/desktop verification attached to the same reviewable
  ...
  hardening/corpus/public-consumer commits through `b32aa13b` pass 47 test files /
  266 tests, typecheck, the production Vite build, and `npm run verify:public`.
