...
- Docs-only handoff checkpoint (contains the evidence verifier): `813516fd97ecd756427cdd4465f3bf4872beb5a0`
...
checkpoint (`813516fd…`) or another checkout that contains that exact script. The immutable source
