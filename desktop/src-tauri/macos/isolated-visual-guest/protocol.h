...
#define GPT_ISOLATED_HELPER_EVENT_BOUND 5U
#define GPT_ISOLATED_HELPER_CONTROL_START 1U
#define GPT_ISOLATED_HELPER_CONTROL_STOP 2U
#define GPT_ISOLATED_HELPER_CONTROL_BIND 3U
#define GPT_ISOLATED_HELPER_BINDING_LENGTH_BYTES 4U
#define GPT_ISOLATED_HELPER_BINDING_MAX_PACKET_BYTES \
