...
- Keep the current TypeScript/desktop verification attached to the same reviewable
  ...
  hardening/corpus/public-consumer/broker-boundary commits through `90879ab1`
  pass 47 test files / 271 tests, typecheck, the production Vite build, and
