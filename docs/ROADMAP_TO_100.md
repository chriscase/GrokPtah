...
- Keep the current TypeScript/desktop verification attached to the same reviewable
  ...
  hardening/corpus/public-consumer/broker-boundary commits through `87e7f9d1`
  pass 47 test files / 268 tests, typecheck, the production Vite build, and
