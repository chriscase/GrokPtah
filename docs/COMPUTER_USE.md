...
| Isolated visual substrate decision | source candidate | Disposable measured VM; no default network, host clipboard/share, credential forwarding, or host input injection. Typed input extensions, helper, guest image, transport, packaging, and proof are not implemented; #288 remains open. |
