...
- Keep the current TypeScript/desktop verification attached to the same reviewable
  ...
  hardening/corpus/public-consumer commits through `6e4fcb99` pass 47 test files /
  267 tests, typecheck, the production Vite build, and `npm run verify:public`.
