...
- Keep the current TypeScript/desktop verification attached to the same reviewable
  ...
  production Vite build; `d94eb445` additionally passes `npm run build:public`
  and a generated-export smoke check. The public barrel remains a staging source
