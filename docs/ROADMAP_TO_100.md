...
- Keep the current TypeScript/desktop verification attached to the same reviewable
  ...
  hardening/corpus/public-consumer/broker-boundary commits through `713d68c1`
  pass 47 test files / 272 tests, typecheck, the production Vite build, and
